...
#Explanation: The data shows that the majority of the respondents  are from Iloilo Science and Technology University, followed by Univerity of Iloilo, and West Visayas State University 
...
#Explanation: The data shows that the majority of the respondents are from Bachelor of Science in Information Technology, followed by BS Civil Engineering and BS Nursing. The courses under the "Others" are courses that only has one respondent, hence we decided to combine them to make the pie chart more organized and clean. 
